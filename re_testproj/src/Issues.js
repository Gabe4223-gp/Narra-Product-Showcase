...
function Issues() {
            ...
            ? {
                ...
                units: property.units.map((unit) =>
                  unit.issues
                    ? {
                        ...unit,
                        issues: unit.issues.filter((issueId) => !selectedIssueIds.has(issueId)),
                      }
                    : unit,
                ),
              }
  ...
  if (selectedIssue !== null) {
    return <IssueProfile issue={selectedIssue} onBack={handleBackToList} onMarkasResolved={markSelectedAsResolved} />
  }
  ...
  return (
    <div className="issues-wrapper">
      ...
      <div className="tab-selector">
        <button
          className={activeTab === "issues" ? "tab-button active" : "tab-button"}
      ...
      {activeTab === "issues" ? (
        <div className="issues-content">
          <div className="issue-list-top">
            <select id="property-select" onChange={handlePropertyChange} value={selectedPropertyID || ""}>
          ...
          <div className="unresolved-issues">
            ...
            <div className="actions">
              ...
              <button onClick={handleDeselectAll} disabled={selectedIssueIds.size === 0}>
                Unselect All
              </button>
              <button onClick={() => markSelectedAsResolved(selectedIssueIds)} disabled={selectedIssueIds.size === 0}>
                ...
                <form>
                  ...
                  <label>
                    ...
                    <textarea
                      ...
                      onChange={(e) => handleAddIssueChange("description", e.target.value)}
                      rows="4"
                      cols="50"
                  ...
                  <div>
                    ...
                    <div>
                      {documents.map((doc, index) => (
                        <div className="issue-doc" key={index}>
          ...
          <div className="resolved-issues">
            <div className="issue-list">
              <div className="resolved-issues-header">
            ...
            <div className="actions">
              ...
              <button onClick={() => markSelectedAsUnresolved()} disabled={selectedIssueIds.size === 0}>
                Mark as Unresolved
              </button>
            </div>
          </div>
          ...
          {showDeleteModal && (
            <div className="overlay">
              <div className="modal">
                ...
                <p>Are you sure you want to delete these issues? This action cannot be undone.</p>
                <div className="button-group">
                  <button onClick={() => setShowDeleteModal(false)}>Cancel</button>
                  <button className="delete-button" onClick={handleDeleteIssues}>
                    Confirm Delete
                  </button>
                </div>
              </div>
